...
#            fig.savefig(str(name) + '.png')
            ...
            amp = a1_max - trough
            per_dif1 = (((start_idx[1]-1) - start_idx[0]))*interval / (60*60)
            per_dif2 = (((start_idx[2]-1) - start_idx[1]))*interval / (60*60)
            per_dif3 = (((start_idx[3]-1) - start_idx[2]))*interval / (60*60)
            per_dif4 = (((start_idx[4]-1) - start_idx[3]))*interval / (60*60)
...
#            fig.savefig(str(name) + '.png')
            ...
            delta1to2 = np.log(a1_max/a3_max)
